...
#
# Exposing things, so they can be imported by `kilroyshare.<thing>`
#
from kilroyshare.interfaces import (
    KilroyFace
)
from kilroyshare.post import (
    PostData
)
...
def resource(
    ...
    package_part = f"{resources.__name__}" \
                   f"{'.' + package_part if package_part else ''}"
